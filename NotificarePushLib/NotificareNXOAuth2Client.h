...
@interface NotificareNXOAuth2Client : NSObject <NotificareNXOAuth2ConnectionDelegate> {
@protected
    BOOL authenticating;
    BOOL persistent;
    ...
    // token exchange
    NotificareNXOAuth2Connection    *authConnection;
    ...
    // delegates
    NSObject<NotificareNXOAuth2ClientDelegate>*    __unsafe_unretained delegate;    // assigned
}
...
@property (nonatomic, strong) NotificareNXOAuth2AccessToken    *accessToken;
@property (nonatomic, unsafe_unretained) NSObject<NotificareNXOAuth2ClientDelegate>*    delegate;
...
- (void)refreshAccessTokenAndRetryConnection:(NotificareNXOAuth2Connection *)retryConnection;
