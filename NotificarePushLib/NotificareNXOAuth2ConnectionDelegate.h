...
@protocol NotificareNXOAuth2ConnectionDelegate <NSObject, NotificareNXOAuth2TrustDelegate>
@optional
 ...
 */
- (void)oauthConnection:(NotificareNXOAuth2Connection *)connection didReceiveResponse:(NSURLResponse *)response;

/*!
 *    The connection did finish and recieved the whole data.
 */
- (void)oauthConnection:(NotificareNXOAuth2Connection *)connection didFinishWithData:(NSData *)data;
 ...
 */
- (void)oauthConnection:(NotificareNXOAuth2Connection *)connection didFailWithError:(NSError *)error;
 ...
 */
- (void)oauthConnection:(NotificareNXOAuth2Connection *)connection didReceiveData:(NSData *)data;

/*!
 *    The connection did send new data
 */
- (void)oauthConnection:(NotificareNXOAuth2Connection *)connection didSendBytes:(unsigned long long)bytesSend ofTotal:(unsigned long long)bytesTotal;

/*!
 * The connection received a redirect response
 */
- (void)oauthConnection:(NotificareNXOAuth2Connection *)connection didReceiveRedirectToURL:(NSURL *)redirectURL;
