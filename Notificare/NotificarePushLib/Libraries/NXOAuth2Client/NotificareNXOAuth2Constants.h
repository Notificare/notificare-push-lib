...
extern NSString * const nNXOAuth2ErrorDomain;                    // domain
 ...
 * malformed.
 */
extern NSInteger const nNXOAuth2InvalidRequestErrorCode;            // -1001

/*
 * The client identifier provided is invalid.
 */
extern NSInteger const nNXOAuth2InvalidClientErrorCode;            // -1002

/*
 * The client is not authorized to use the requested response
 * type.
 */
extern NSInteger const nNXOAuth2UnauthorizedClientErrorCode;        // -1003

/*
 * The redirection URI provided does not match a pre-registered
 * value.
 */
extern NSInteger const nNXOAuth2RedirectURIMismatchErrorCode;    // -1004

/*
 * The end-user or authorization server denied the request.
 */
extern NSInteger const nNXOAuth2AccessDeniedErrorCode;            // -1005

/*
 * The requested response type is not supported by the
 * authorization server.
 */
extern NSInteger const nNXOAuth2UnsupportedResponseTypeErrorCode;// -1006

/*
 * The requested scope is invalid, unknown, or malformed.
 */
extern NSInteger const nNXOAuth2InvalidScopeErrorCode;            // -1007
 ...
 */
extern NSInteger const nNXOAuth2CouldNotRefreshTokenErrorCode;    // -2001


#pragma mark HTTP Errors

extern NSString * const nNXOAuth2HTTPErrorDomain;                // domain
...
typedef enum  {
    nNXOAuth2TrustModeAnyCertificate      = 1 << 0,
    nNXOAuth2TrustModeSystem              = 1 << 1,
    nNXOAuth2TrustModeSpecificCertificate = 1 << 2
} nNXOAuth2TrustMode;



extern NSString * const nNXOAuth2AccountStoreErrorKey;
